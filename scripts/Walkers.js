...
import { filterWalkCitiesByWalker } from "./CityList.js"
    ...
    (clickEvent) => {
        ...
        */
        if (itemClicked.id.startsWith("walker")) {
            ...
            */
            const [, walkerId] = itemClicked.id.split("--") // split into a string
            ...
            for (const walker of walkers) {
                ...
                */
                if (walker.id === parseInt(walkerId)) { 
                    // parseInt makes it able to compare string to interger
                    const updatedWalkerCities = filterWalkCitiesByWalker(walker)
                    const cities = assignedCityNames(updatedWalkerCities)
